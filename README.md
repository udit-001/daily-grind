...
Every sprite, song, and map is generated by code at runtime — Canvas2D rendering, WebAudio chiptune, programmatic tile maps. No framework, no assets folder. To contribute (or to point an AI agent at this codebase), read [`AGENTS.md`](AGENTS.md): file layout, verification steps, and conventions live there. Self-running test harnesses for specific mechanics sit in `debug/`.
