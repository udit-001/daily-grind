...
const LEVELS = [
  ...
  {
    name: 'THE REORG',
    quip: 'New managers dropped. Old ones enraged.',
    w: 104, h: 15,
...
const COWORKER_LINES = [
  ...
  'Have you seen the new KPIs?',
  "I'm a coffee-based lifeform.",
  'Living the dream.',
  'TPS reports due EOD.',
  "Let's circle back.",
  "Out of office? Never heard of it.",
  'It works on my machine.',
  "You're on mute.",
  'LGTM. Ship it.',
  "Let's take this offline.",
  "Quick sync? It's 4:59.",
  "AI could've written this.",
  'Who closed my ticket?!',
  'My RSU vested. I feel nothing.',
  'This is a stretch assignment.',
];

const DEATH_MSGS = {
  enemy: 'Absorbed into middle management.',
  intern: 'Bowled over by a fleeing junior.',
  plane: 'Fatal paper cut.',
  shred: [
  ...
  pit: 'You fell into the void between departments.',
  boss: 'Did not pass the EXIT INTERVIEW.',
  wave: 'Flattened by quarterly results.',
